...
const BUSD_MAINNET = testnetTokens.xusd
const { wsats: WETH } = tokens

console.log(BUSD_MAINNET,":BUSD_MAINNET");
/**
...
export const useCakeBusdPrice = (): Price | undefined => {
  const cakeBusdPrice = useBUSDPrice(tokens.stx)
...
export const useBNBBusdPrice = (): Price | undefined => {
  const bnbBusdPrice = useBUSDPrice(tokens.wsats)
  return bnbBusdPrice
}
