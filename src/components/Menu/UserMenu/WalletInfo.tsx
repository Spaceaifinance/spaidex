  ...
  return (
    <>
      ...
      <Flex alignItems="center" justifyContent="end" mb="24px">
        <LinkExternal href={getBscScanLink(account, 'address')} className="bnbscan">{t('View on BscScan')}</LinkExternal>
      </Flex>
      <Button variant="secondary" width="100%" onClick={handleLogout} className='theme-btn'>
        {t('Disconnect Wallet')}
      </Button>
    </>
  )
