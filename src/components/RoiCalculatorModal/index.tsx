    ...
    >
      <ScrollableContainer>
        <Flex flexDirection="column" mb="8px">
          <Text color="secondary" bold fontSize="12px" textTransform="uppercase" className='mb-4'>
          ...
          />
          <Flex justifyContent="space-between" mt="8px" className='mt-4'>
            <Button
              scale="xs"
              p="4px 16px"
              width="68px"
          ...
          <Text mt="24px" color="secondary" bold fontSize="12px" textTransform="uppercase" className='mb-4'>
            {t('Staked for')}
          </Text>
