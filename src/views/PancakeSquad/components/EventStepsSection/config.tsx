  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active Space AI Finance Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold CAKE'),
      bodyText: [t('Each NFT costs CAKE to mint. Remember you also need ETH to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://spaceaifinance.exchange/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82"
            target="_blank"
            width="100%"
          >
            {t('Buy CAKE')}
