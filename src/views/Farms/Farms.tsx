...
// import { useGetTotalLiquidity } from 'hooks/api'
...
const Farms: React.FC = () => {
  ...
  // const gettotalLiquidity = useGetTotalLiquidity()
...
<img alt="logo" src="../../../../images/design.png" className='designimg designimg_moreindex'/>

      <PageHeader className='page_fram_pos'>
      ...
      <Page className='page_fram_pos'>
        ...
        {showFinishedPools && (
          <Text fontSize="16px" color="failure" pb="32px" className='text-center mt-4'>
            {t('These pools are no longer distributing rewards. Please unstake your tokens.')}
          </Text>
        )}
        {stakedOnly && (
 <Text fontSize="16px" color="failure" pb="32px" className='text-center mt-2'>
