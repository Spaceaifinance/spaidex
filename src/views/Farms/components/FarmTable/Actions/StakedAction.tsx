...
const Staked: React.FunctionComponent<StackedActionProps> = ({
  ...
  if (!account) {
    return (
      <ActionContainer>
        <ActionTitles>
          <Text bold textTransform="uppercase" color="textSubtle" fontSize="12px" className='mb-2'>
            {t('Start Farming')}
          </Text>
        </ActionTitles>
        <ActionContent>
  ...
  return (
    <ActionContainer>
      ...
      <ActionContent>
        <Button className="theme-btn" width="100%" disabled={requestedApproval} onClick={handleApprove} variant="secondary">
          {t('Enable')}
        </Button>
      </ActionContent>
    </ActionContainer>
