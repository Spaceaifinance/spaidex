...
const useGetTopFarmsByApr = (isIntersecting: boolean) => {
  ...
  const [topFarms, setTopFarms] = useState<FarmWithStakedValue[]>([null, null, null, null, null,null, null, null, null, null,null, null, null, null,null,null,null,null])
  ...
  useEffect(() => {
    const getTopFarmsByApr = (farmsState: DeserializedFarm[]) => {
      ...
      setTopFarms(sortedByApr.slice(0, 19))
    }
