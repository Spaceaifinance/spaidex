  ...
  return (
    <>
            ...
            <QuestionHelper
              text={
                <>
                  ...
                  <Text>- {t('%amount% towards SpAI buyback and burn', { amount: '0.05%' })}</Text>
                </>
              }
              ml="4px"
            />
      ...
      <AutoRow>
        ...
        {swapErrorMessage ? <SwapCallbackError error={swapErrorMessage.replace("PancakeRouter", "SparcoRouter")} /> : null}
      </AutoRow>
    </>
  )
}
