...
import { Button, Text, ArrowDownIcon, Box, useModal, ArrowUpIcon } from '@pancakeswap/uikit'
...
export default function Swap({ history }: RouteComponentProps) {
  ...
  return (
    <div>
    <Page className='swap_bg farm_page_bg'>
    <img alt='logo' src="../../../../images/design.png" className='designimg designimg_moreindex'/>

      <AppBody>
        <AppHeader title={t('AI Swap')} subtitle={t('Trade tokens in an instant')} />
        <Wrapper id="swap-page">
          ...
          <Box mt="1rem">
            {swapIsUnsupported ? (
              ...
              <ConnectWalletButton width="100%" className="theme-btn" />
            ) : showWrap ? (
