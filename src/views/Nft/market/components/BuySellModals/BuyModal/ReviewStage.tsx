    ...
    <>
      <Flex px="24px" pt="24px" flexDirection="column">
        ...
        <BorderedBox>
          ...
          <Text small color="textSubtle">
            {t('%symbol% in wallet', { symbol: paymentCurrency === PaymentCurrency.ETH ? 'ETH' : 'WBNB' })}
          </Text>
          {!account ? (
          ...
          <Message p="8px" variant="danger">
            <Text>
              {t('Not enough %symbol% to purchase this NFT', {
                symbol: paymentCurrency === PaymentCurrency.ETH ? 'ETH' : 'WBNB',
              })}
            </Text>
          </Message>
        )}
        <Flex alignItems="center">
          <Text my="16px" mr="4px">
            {t('Convert between ETH and WBNB for free')}:
          </Text>
          <Button
            as={Link}
            p="0px"
            ...
            external
            variant="text"
            href={`${BASE_URL}/swap?inputCurrency=ETH&outputCurrency=0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c`}
          >
            {t('Convert')}
          </Button>
        </Flex>
      ...
      <Flex px="24px" pb="24px" flexDirection="column">
        ...
        <Button
          ...
          external
          style={{ width: '100%' }}
          href={`${BASE_URL}/swap?outputCurrency=ETH`}
          variant="secondary"
        >
          {t('Get %symbol1% or %symbol2%', { symbol1: 'ETH', symbol2: 'WBNB' })}
        </Button>
      </Flex>
    </>
  )
