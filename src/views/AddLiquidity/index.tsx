...
export default function AddLiquidity({
  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB_: Currency) => {
      console.log("currencyB_",currencyB_);
...
<img alt="logo" src="../../../../images/design.png" className='designimg designimg_moreindex'/>
    <Page className='swap_bg pading_more_add'>
      <AppBody>
        <div className="headong headong_blk_mob">
        <AppHeader
            ...
            {currencies[Field.CURRENCY_A] && currencies[Field.CURRENCY_B] && pairState !== PairState.INVALID && (
              <>
                <LightCard padding="0px" borderRadius="20px">
                  ...
                  <LightCard padding="1rem" borderRadius="20px" className="light_card_content">
                    <PoolPriceBar
                      currencies={currencies}
                      poolTokenPercentage={poolTokenPercentage}
                      noLiquidity={noLiquidity}
      ...
      {!addIsUnsupported ? (
        pair && !noLiquidity && pairState !== PairState.INVALID ? (
          <AutoColumn style={{ minWidth: '20rem', width: '100%', maxWidth: '400px', marginTop: '1rem' }} className="bottom_conrtnet">
