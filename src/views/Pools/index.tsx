...
<img src="../../../../images/design.png" alt='logo' className='designimg designimg_moreindex'/>
    <img src="../../../../images/design.png" alt='logo' className='designimg designimg_moreindex'/>
      ...
      <PageHeader className='page_fram_pos'>
        <Flex justifyContent="space-between" flexDirection={['column', null, null, 'row']}>
          <Flex flex="1" flexDirection="column" mr={['8px', 0]}>
            ...
            <Heading scale="md" color="secondary" className='mb-3-stak'>
              {t('Just stake tokens to earn.')}
            </Heading>
