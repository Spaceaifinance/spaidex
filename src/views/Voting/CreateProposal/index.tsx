...
const CreateProposal = () => {
  ...
  const { cakeBalance} =useGetVotingPower(14487555, true)
  ...
  return (
    <>
      <Container py="40px">
        <PageMeta />
        <Box mb="48px" className="breadcrumbs">
          <Breadcrumbs>
            <a href="http://www.sparco.network/" title="example">{t('Home')}</a>
                  ...
                  {account ? (
                    <>
                      <Button
                        ...
                        disabled={!isEmpty(formErrors) || cakeBalance < VOTE_THRESHOLD}
                        mb="16px"
                      >
                        {t('Publish')}
                      </Button>
                      <Text color="failure" as="p" mb="4px">
                        {t('You need at least %count% rise to publish a proposal.', { count: VOTE_THRESHOLD })}{' '}
                      </Text>
