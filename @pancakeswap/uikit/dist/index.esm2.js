...
var Logo$2 = function (_a) {
    ...
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 156 26" }, props),
        React.createElement("image", { width: 128, height: 30, href: "/images/wsum.png" })));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#ededf5", backgroundDisabled: "#E9EAEB", backgroundAlt: "#fff", backgroundAlt2: "rgba(255, 255, 255, 0.7)", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#ededf5", dropdownDeep: "#ededf5", invertedContrast: "#FFFFFF", input: "#f2f3f9", inputSecondary: "#d7caec", tertiary: "#f6f7ff", text: "#8180e0", textDisabled: "#BDC2C4", textSubtle: "#8180e0", disabled: "#E9EAEB", gradients: {
        bubblegum: "linear-gradient(139.73deg, #f6f7ff 0%, #f6f7ff 100%)",
...
var WalletCard = function (_a) {
    ...
    return (React__default.createElement(WalletButton, { variant: "tertiary", onClick: function () {
        ...
        React__default.createElement(Text, { fontSize: "14px", color: "#8180e0" }, title)));
};
